...
export const researchFacilitiesCreateFormSchema = z.object({
...
export type TResearchFacilitiesCreateFormDataType = z.infer<typeof researchFacilitiesCreateFormSchema>;

export const defaultValues: Partial<TResearchFacilitiesCreateFormDataType> = {
  name: '',
  slug: '',
  shortDescription: '',
  description: '',
...
export const researchFacilitiesCreateFields: FormField<TResearchFacilitiesCreateFormDataType>[] = [
