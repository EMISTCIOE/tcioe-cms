...
export type TDepartmentCreateFormDataType = z.infer<typeof departmentCreateFormSchema>;

// NOTE -  Define default Values for the Form using the generated type
export const defaultValues: Partial<TDepartmentCreateFormDataType> = {
  name: '',
  shortName: '',
  slug: '',
  isActive: true,
...
export const departmentCreateFields: FormField<TDepartmentCreateFormDataType>[] = [
