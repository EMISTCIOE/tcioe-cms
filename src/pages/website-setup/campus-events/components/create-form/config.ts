...
export const campusEventsCreateFormSchema = z.object({
...
export type TCampusEventsCreateFormDataType = z.infer<typeof campusEventsCreateFormSchema>;

// NOTE -  Define default Values for the Form using the generated type
export const defaultValues: Partial<TCampusEventsCreateFormDataType> = {
  title: '',
  descriptionShort: '',
  descriptionDetailed: '',
  eventType: undefined,
